...
class _$CartImpl implements _Cart {
  ...
  @override
  String toString() {
    return 'Cart(id: $id, items: $items, buyerId: $buyerId, buyerName: $buyerName)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id,
      const DeepCollectionEquality().hash(_items), buyerId, buyerName);
...
abstract class _CartItem implements CartItem {
  factory _CartItem(
      ...
      required final double quantity}) = _$CartItemImpl;
